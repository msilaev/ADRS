...
##############################################
    ...
    fig_0, ax = plt.subplots(2, 1, figsize=(10, 8), sharex=True, sharey=True)
    ...
    ax_0.hist(MOS_pr, bins=fixed_bins, alpha=0.8, color="magenta", label="MU-GAN Alt-1")
    ax_0.hist(MOS_hr, bins=fixed_bins, alpha=0.4, color="blue", label="WB")


    ax_0.set_xlim([2, 5])
    ax_0.set_ylabel("# Samples", fontsize=font_size1)
    ax_0.tick_params(axis='both', which='major', labelsize=font_size1)
    ax_0.legend(fontsize=font_size)
    ax_0.grid(color='gray', linestyle='--', linewidth=0.5)
    ax_0.set_xlabel("MOS", fontsize=font_size1)
    ax_0.tick_params(axis='both', which='major', labelsize=font_size1)
    ...
    ax_1.hist(MOS_pr_gan_5, bins=fixed_bins, alpha=0.8, color="magenta", label="MU-GAN Alt-5")
    ax_1.hist(MOS_hr, bins=fixed_bins, alpha=0.4, color="blue", label="WB")

    ax_1.set_ylabel("# Samples", fontsize=font_size1)
    ax_1.tick_params(axis='both', which='major', labelsize=font_size1)
    ax_1.legend(fontsize=font_size)
    ax_1.grid(color='gray', linestyle='--', linewidth=0.5)
    ax_1.set_xlabel("MOS", fontsize=font_size1)
    ...
    ax_0.hist(SNR_pr, bins=fixed_bins, alpha=0.8, color="magenta", label="MU-GAN Alt-1")
    ...
    ax_0.legend(fontsize=font_size)
    ax_0.grid(color='gray', linestyle='--', linewidth=0.5)
    ax_0.set_xlabel("SNR", fontsize=font_size1)
    #ax_0.set_title("Audiounet vs. HR vs. GAN", fontsize=font_size)
    ...
    ax_1.hist(SNR_pr_gan_5, bins=fixed_bins, alpha=0.8, color="magenta", label="MU-GAN Alt-5")
    ...
    ax_1.legend(fontsize=font_size)
    ax_1.grid(color='gray', linestyle='--', linewidth=0.5)
    ax_1.set_xlabel("SNR", fontsize=font_size1)
    #ax_1.set_title("Audiounet vs. GAN Alt 3 vs. HR", fontsize=font_size)
