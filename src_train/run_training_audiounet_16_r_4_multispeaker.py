...
from models.gan import Discriminator, BCEWithSquareLoss
...
def train( args):
    ...
    # "singlespeaker.r_4.gan.b128.sr_16000.discriminator_gan.epoch_400.pth")
    ...
    #model_path = os.path.join("../logs",
    # "singlespeaker.r_4.gan.b128.sr_16000.generator_gan.epoch_400.pth")
