...
class WithLoss_G_new(nn.Module):
    ...
    def forward(self, hr, fake_patches, adv_weight = 0.001):
        ...
        if self.autoencoder is not None:
            ...
            g_loss = avg_sqrt_l2_loss + 0*adv_weight * g_gan_loss + 0*feature_loss
            # ------------
            # Zero adv_weight means decoupling Generator from Discriminator
            # ------------
...
def train( args):
    ...
    # "singlespeaker.r_4.gan.b128.sr_16000.discriminator_gan.epoch_450.pth")
    ...
    #model_path = os.path.join("../logs",
    # "singlespeaker.r_4.gan.b128.sr_16000.generator_gan.epoch_450.pth")
