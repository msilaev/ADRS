...
def train( args):
    ...
    # if we want to start from checkpoint
    #model_path = os.path.join("logs",
    # "singlespeaker.r_4.gan.b16.sr_16000.discriminator_gan.epoch_250.pth")
    ...
    #model_path = os.path.join("../logs",
    # "singlespeaker.r_4.gan.b16.sr_16000.generator_gan.epoch_250.pth")
