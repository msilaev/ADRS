...
def train( args):
    ...
    # "singlespeaker.r_4.gan.b128.sr_16000.discriminator_gan.epoch_485.pth")
    ...
    #model_path = os.path.join("../logs",
    # "singlespeaker.r_4.gan.b128.sr_16000.generator_gan.epoch_485.pth")
    ...
    for epoch_idx in range(1, epochs + 1):
        ...
        for i, (lr_sound, hr_sound) in enumerate(train_loader, 0):
            ...
            # ------------
            # Update Discriminator three times less frequent than Generator
            # ------------
            if (i%3 == 0):
