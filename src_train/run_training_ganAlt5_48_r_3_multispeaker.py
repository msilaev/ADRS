...
def train( args):
    ...
    # "singlespeaker.r_3.gan.b128.sr_48000.discriminator_gan.epoch_490.pth")
    ...
    #model_path = os.path.join("../logs",
    # "singlespeaker.r_3.gan.b128.sr_48000.generator_gan.epoch_490.pth")
    ...
    for epoch_idx in range(1, epochs + 1):
        ...
        for i, (lr_sound, hr_sound) in enumerate(train_loader, 0):
            ...
            # ------------
            # Update Discriminator five times less frequent than Generator
            # ------------
            if (i%5 == 0):
