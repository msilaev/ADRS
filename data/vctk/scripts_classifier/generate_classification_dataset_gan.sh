...
python ../prep_vctk_classificator.py \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-train-1.$SCA.$SR.$DIM.$STR.$SAM.h5
...
python ../prep_vctk_classificator.py\
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-val-1.$SCA.$SR.$DIM.$STR.$SAM.h5
