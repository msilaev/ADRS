...
DIM=49152                            # Patch dimension
STR=49152                          # Patch stride
PATCH_SIZE=8192
...
python ../prep_vctk_classificator_sec_1.py\
    ...
    --in-dir $(pwd) \
    --out vctk-hifigan-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp \
    --scale $SCA \
    --sr $SR \
    --model hifigan \
    --dimension $DIM \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-hifigan-multispesaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-hifigan-multispeaker-class-interp-val-sec-1.$SCA.$SR.$DIM.$STR.$SAM.h5
...
python ../prep_vctk_classificator_sec_1.py \
    ...
    --in-dir $(pwd) \
    --out vctk-hifigan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp \
    --scale $SCA \
    --sr $SR \
    --model hifigan \
    --dimension $DIM \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-hifigan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-hifigan-multispeaker-class-interp-train-sec-1.$SCA.$SR.$DIM.$STR.$SAM.h5
