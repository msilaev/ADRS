...
python ../prep_vctk_classificator_sec_2.py \
    ...
    --in-dir $(pwd) \
    --out vctk-gan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp \
    --scale $SCA \
    --sr $SR \
    --model gan \
    --dimension $DIM \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-train-sec-2.$SCA.$SR.$DIM.$STR.$SAM.h5
...
python ../prep_vctk_classificator_sec_2.py\
    ...
    --in-dir $(pwd) \
    --out vctk-gan-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp \
    --scale $SCA \
    --sr $SR \
    --model gan \
    --dimension $DIM \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-val-sec-2.$SCA.$SR.$DIM.$STR.$SAM.h5
