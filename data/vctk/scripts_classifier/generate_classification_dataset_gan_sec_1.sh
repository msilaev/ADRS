...
python ../prep_vctk_classificator_sec_1.py \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-train-sec-1.$SCA.$SR.$DIM.$STR.$SAM.h5
...
python ../prep_vctk_classificator_sec_1.py\
    ...
    --stride $STR \
    --sam $SAM
mv vctk-gan-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-gan-multispeaker-class-interp-val-sec-1.$SCA.$SR.$DIM.$STR.$SAM.h5
