...
python ../prep_vctk_classificator_sec_2.py \
    ...
    --stride $STR \
    --sam $SAM
mv vctk-audiounet-multispeaker-class-interp-train.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-audiounet-multispeaker-class-interp-train-sec-2.$SCA.$SR.$DIM.$STR.$SAM.h5
...
python ../prep_vctk_classificator_sec_2.py\
    ...
    --stride $STR \
    --sam $SAM
mv vctk-audiounet-multispeaker-class-interp-val.$SCA.$SR.$DIM.$STR.$SAM.h5.tmp vctk-audiounet-multispeaker-class-interp-val-sec-2.$SCA.$SR.$DIM.$STR.$SAM.h5
